  ...
  _createClass(App, [{
    ...
    value: function handleSubmit(e) {
      ...
      (0, _axios2.default)({
        ...
        _this3.setState({
          newImage: '',
          suspects: _this3.state.suspects.concat({
            data: _this3.state.newImage,
    ...
    key: 'handleReport',
    value: function handleReport(imageData, matchIdx) {
      var _this4 = this;

      return function (e) {
        e.preventDefault();
        var bodyFormData = new FormData();
        bodyFormData.set('image_contents', _this4.state.newImage);
        ...
        (0, _axios2.default)({
          ...
          _this4.setState({
            ...
            suspects: _this4.state.suspects.map(function (suspect, idx) {
              return idx === matchIdx ? Object.assign({}, _extends({}, suspect), { reported: true }) : suspect;
            })
          });
        });
      };
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'h1',
          null,
          ' GOTHAM ANONYMOUS TIP SERVICE '
        ),
        _react2.default.createElement(
          'p',
          null,
          ' Seen any shifty fellows with blotched makeup lurking in the shadows? Check them against our database and bring them into the light. '
        ),
        _react2.default.createElement(
          'h3',
          null,
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'legend',
            null,
            ' Crook Submission Form '
          ),
          _react2.default.createElement(
            'div',
            { className: 'crook-lookup' },
            _react2.default.createElement(
              'div',
              null,
              _react2.default.createElement('input', { className: 'crook-loader', type: 'file', id: 'file', onChange: handleLoad }),
              _react2.default.createElement(
                'label',
                { htmlFor: 'file' },
                'Choose a file'
              ...
              _react2.default.createElement(
                'button',
                { className: 'crook-submit', type: 'submit', onClick: handleSubmit },
                ' Submit '
              )
            ),
            newImage ? _react2.default.createElement(
              'div',
              null,
              _react2.default.createElement(
                'p',
              ...
              _react2.default.createElement('img', { className: 'preview', src: newImage })
            ) : null
          )
        ),
        _react2.default.createElement(_.Lineup, { suspects: suspects, handleReport: handleReport })
      );
    }
  }]);
...
exports.default = function (props) {
  var suspects = props.suspects,
      handleReport = props.handleReport;

  if (suspects.length) return [_react2.default.createElement(
    "h3",
    { key: "lineup-head" },
    " Submission History "
  ), _react2.default.createElement(
    "div",
    { key: "lineup-body", className: "lineup" },
    suspects.map(function (suspect, idx) {
      var criticalMatch = +suspect.percentage > 70,
          matchMsg = suspect.likeness === 'No match' ? "" + suspect.likeness : suspect.likeness + " : " + suspect.percentage + "% match";
      return _react2.default.createElement(
        "div",
        { className: "suspect", key: idx + "-" + suspect.data.slice(0, 25) + "}" },
        _react2.default.createElement(
          "div",
          { className: "suspect-top" },
          _react2.default.createElement(
            "p",
            { className: criticalMatch ? 'critical' : '' },
            " ",
            matchMsg,
            " "
          ),
          suspect.reported ? _react2.default.createElement(
            "p",
            null,
            " REPORTED "
          ) : suspect.likeness === 'No match' ? null : _react2.default.createElement(
            "button",
            { className: "suspect-report", onClick: handleReport(suspect.data, idx) },
            " REPORT "
          )
        ),
        _react2.default.createElement(
          ...
          _react2.default.createElement("img", { src: suspect.data })
        )
      );
    })
  )];else return null;
...
var _Lineup = __webpack_require__(/*! ./Lineup */ "./src/components/Lineup.js");

Object.defineProperty(exports, 'Lineup', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_Lineup).default;
  }
});
